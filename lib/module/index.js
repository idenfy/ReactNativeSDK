...
const IdenfyReactNative = NativeModules.IdenfyReactNative ? NativeModules.IdenfyReactNative : new Proxy({}, {
  get() {
...
export function startRequestUpdate(config) {
  return IdenfyReactNative.startRequestUpdate(config);
}

// Export models
export { DocumentCameraFrameVisibility, HiddenForAllCountriesAndDocumentTypes, HiddenForSpecificCountriesAndDocumentTypes } from './models/DocumentCameraFrameVisibility';
